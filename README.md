...
* 解決措施： 
  * 一個一個解決就行了, 參考以上我自行加上去的代碼截圖.
  * 最後那個問題 port 換到 7860 可解.
    
# 項目總結與展望：
  * 這個專案成功了, 之後我就有能力開發客服相關的 RAG 對話機器人.  
  * 客服市場的潛力很大, 因為隱私考量所以適合在本地自己的設備上跑, 這個市場AI從雲端真的落地開花的關鍵.
  * 我喜歡 scalable 的市場, 投入最開始的一份努力, 微調一下就能 scalable 給許多不同的客戶使用. 而不是來100個客人就要投入100份成本的市場. 
  * 

# 其他：
  這次 NVIDIA AI-AGENT 夏季訓練營讓我獲益良多, 上課教材給的是很基礎的程式碼, 給你環境搭建與基本 code 的寫法.  
  而最有收穫的是課後要自己成立一個專案, 思考應用場景, 程式碼缺少的許多拼圖要怎麼做, 遇到問題要怎樣迎頭解決還是技巧繞開.  
  雖然每天上課只有兩小時, 但每天課前課後幾乎都在自習, 實際學習的時間至少數倍
